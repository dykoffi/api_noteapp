...
console.log(`INSERT INTO app.enseignants (nom, prenoms, pseudo, photo, mdp, email, no_cni, date_exp_cni, matricule) VALUES`)
for (let i = 0; i < taille; i++) {
    ...
    matricule = `${nom.substring(0, 3)}-${prenoms.substring(0, 2)}/${date_exp_cni.substring(0, 4)}`

    console.log(`('${nom}', '${prenoms}', '${pseudo}', '${photo}', md5('${mdp}'), '${email}', '${no_cni}', '${date_exp_cni}', '${matricule}')${i == taille - 1 ? ";" : ","}`)
}
