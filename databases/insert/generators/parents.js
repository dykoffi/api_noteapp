...
console.log(`INSERT INTO app.parents (nom, prenoms, pseudo, photo, mdp, email, no_cni, date_exp_cni, contacts) VALUES`)
for (let i = 0; i < taille; i++) {
    ...
    console.log(`('${nom}', '${prenoms}', '${pseudo}', '${photo}', md5('${mdp}'), '${email}', '${no_cni}', '${date_exp_cni}', '${contacts}')${i == taille - 1 ? ";" : ","}`)
